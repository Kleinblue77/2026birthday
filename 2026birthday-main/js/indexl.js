var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Hi老婆|祝你|生日快乐|打开声音|Ready？|#countdown 3||');
    }
...
S.Drawing = (function () {
  ...
  return {
    ...
    adjustCanvas: function () {
      const bottomSafe = window.visualViewport ? window.visualViewport.offsetTop : 0;
      canvas.width = window.innerWidth-20;
      canvas.height = window.innerHeight-20 - bottomSafe;
    },
...
S.ShapeBuilder = (function () {
  const gap = window.innerWidth <= 480 ? 8 : 13;
  ...
  return {
    ...
    letter: function (l) {
      ...
      s = Math.min(fontSize,
                  (shapeCanvas.width / shapeContext.measureText(l).width) * 0.92 * fontSize, 
